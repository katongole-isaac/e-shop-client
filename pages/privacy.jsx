    ...
    <React.Fragment>
      <div className="text-gray-900">
        ...
        <h1 className="font-bold my-2 text-2xl ">
          Privacy Policy for [ org name ]
        </h1>
        <div className="mb-3 space-y-3">
          <p>
            At [ company name ], accessible from https://company.org, one of our
            main priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by [ company name ] and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in [ company name ]. This policy is
            not applicable to any information collected offline or via channels
            other than this website.
          </p>
        </div>

        <h2 className="font-semibold text-xl my-2 ">Consent</h2>
        <div className="mb-3 space-y-3">
          <p>
        ...
        <div className="mb-3 space-y-3">
          ...
          <ul className="space-y-2 pl-4 list-inside list-disc">
        ...
        <h2 className="font-semibold text-xl my-2">Log Files</h2>
        <div className="mb-3">
          <p className=" leading-6">
            [ company name ] follows a standard procedure of using log files.
        ...
        <h2 className="font-semibold text-xl my-2">Cookies and Web Beacons</h2>
        <div className="mb-3">
          <p className=" leading-6">
        ...
        <div className="mb-3 space-y-3">
          <p>
            ...
            advertising partners of [ company name ].
          </p>

          <p className=" leading-6">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on [ company name ],
          ...
          <p>
            Note that [ company name ] has no access to or control over these
        ...
        <div className="mb-3 space-y-3">
          <p className=" leading-6">
            [ company name ]'s Privacy Policy does not apply to other
        ...
        <div className="mb-3 space-y-3  ">
          ...
          <div className="[&>p]:ml-3 space-y-2 ">
            <p>
        ...
        <h2 className="font-semibold text-xl my-2">Children's Information</h2>
        ...
        <div className="mb-3 space-y-3">
          ...
          <p className="leading-6">
            [ company name ] does not knowingly collect any Personal
        ...
        <h2 className="font-semibold text-xl my-2">Contact Us</h2>
...
Privacy.getLayout = (page) => (
  <AuthLayout widthClasses="max-w-xl" classes="bg-slate-50 scroll-smooth">
    {page}
  </AuthLayout>
);
